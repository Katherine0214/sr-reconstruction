...
class SRResNet(nn.Module):
    ...
    def __init__(self, large_kernel_size=9, small_kernel_size=3, n_channels=64, n_blocks=16, scaling_factor=4):
        ...
        assert scaling_factor in {2, 4, 8, 16}, "放大比例必须为 2、 4 或 8!"
...
class TruncatedVGG19(nn.Module):
    ...
    def __init__(self, i, j):
        ...
        # 加载预训练的VGG模型
        vgg19 = torchvision.models.vgg19(pretrained=False)  # 若能联网，则是True
        vgg19.load_state_dict(torch.load(r'/home/zhangc/project/SRResNet/data/vgg19-dcbb9e9d.pth'))
