...
if __name__ == '__main__':
    ...
    checkpoint = torch.load(srgan_checkpoint, map_location={'cuda:0': 'cuda:1'})    # 当用gpu=“1”训练并用“1”推理时，需要将map_location删掉
    ...
    with torch.no_grad():
        ...
        sr_img.save('/home/zhangc/project/sr-reconstruction/results/result_save/SRGAN_8.jpg')
